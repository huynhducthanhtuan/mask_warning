...
const ScreensRoot = () => {
  return (
    <Routes>
      ...
      <Route path="/admin/reports-manager/report-detail/:reportId" element={<AdminReportDetail />} />
      <Route path="/admin/reports-manager/user-detail/:userId" element={<AdminReportUserDetail />} />
