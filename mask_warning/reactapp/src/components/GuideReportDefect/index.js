            ...
            <div className={styles.headerGuide}>
                <div>
                    <div>
                        ...
                        <img className={styles.image} src="./img/report_defect_step1.png"></img>
                    </div>

                    <div>
                        <p className={styles.text}>2. Choose type of bug</p>
                        <img className={styles.image} src="./img/report_defect_step2.png"></img>
                    </div>
                ...
                <div className={styles.item}>
                    <div>
                        ...
                        <img className={styles.image2} src="./img/report_defect_step3.png"></img>
                    </div>

                    <div >
                        <p className={styles.text}>4. If you want to clear all contents click "Clear" or if you want to send report
                        click "Report"</p>
